      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-xs mt-2" style={{ color: "var(--ink-muted)" }}>{t("flashcard.tapReveal")}</p>
          </div>
          ...
          <div
            ...
            className="flex flex-col justify-center gap-2"
          >
            <p className="text-xs uppercase tracking-widest mb-1" style={{ color: "var(--ink-muted)" }}>{t("flashcard.explanation")}</p>
