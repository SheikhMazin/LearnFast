  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      >
        ...
        >
          <div>
            <p className="text-sm font-semibold" style={{ color: "var(--ink)" }}>Ask a question</p>
            <p className="text-xs truncate max-w-64" style={{ color: "var(--ink-muted)" }}>About: {topic}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          {thread.map((entry, i) => (
            <div key={i} className="space-y-2">
              ...
              >
                <p className="text-xs mb-1 font-semibold" style={{ color: "var(--green-light)" }}>You</p>
